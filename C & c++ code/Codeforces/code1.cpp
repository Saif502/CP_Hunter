/*
PB-3: Ther will be t test cases (1 <= t <= 10^6). In each case,
     given n (1<= n <= 10^18). Do one of the operations written
     below multiple times. If n is even then update it dividing by 2,
     else increase the value of n by 1. How many operations
     do you have to do to make n = 1?
*/
/*
    Time complexity:(t*log(n))
*/
#include<bits/stdc++.h>
#include<iostream>
#include<math.h>
